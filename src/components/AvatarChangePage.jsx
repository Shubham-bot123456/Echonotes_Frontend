...
export default function AvatarChangePage() {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-screen flex justify-evenly">
            <AnimatePresence>
                <motion.div className="p-5 m-auto w-[80vw] h-[80vh]  rounded-xl shadow-2xl relative"
                            initial={{
                                opacity: 0,
                                scale: 0.4,
                                translateY: 200,
                ...
                >
                    ...
                    {loading ? (
                        ...
                        <div
                            className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 items-center h-[90%] p-3 overflow-auto">
                            <div
